...
[assert_{true|false} '\<commandGenerate\> [\<argList\>] | assert_output_true [\<commandExpected\> [\<argList\>]]'](https://github.com/WhisperingChaos/assert.source.sh/blob/master/README.md#assert_output_true-commandexpected-arglist-inputdelim-commandgenerate-arglist)
...
[assert_{true/false} '\<commandGenerate\> [\<argList\>] | assert_output_false [\<commandExpected\> [\<argList\>]]'](https://github.com/WhisperingChaos/assert.source.sh/blob/master/README.md#assert_output_false-commandexpected-arglist-inputdelim-commandgenerate-arglist)
