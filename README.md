...
Negated form of **assert_output_true**.  Requires every delimited block of bytes generated by **\<commandGenerate\>** be different from its corresponding block produced by **\<commandExpected\>**. Otherwise, if at least one corresponding block matches, this assertion is triggered.  As opposed to **assert_output_true** a mismatch in the number of either **\<commandGenerate\>** or **\<commandExpected\>** will affirm the assertion, as long as provided compared outputs affirm the assertion.  
